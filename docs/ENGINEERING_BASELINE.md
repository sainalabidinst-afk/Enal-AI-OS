...
|Rangkaian Tes|✅ **166 collected**|Semua tes lulus|
...
├── sdk/                # Python SDK
├── tests/              # Unit tests (166 collected)
├── tools/
...
|5|**Tes Dulu**|Setiap perubahan harus menyertakan atau memperbarui test. Baseline: 166 collected. Tidak ada regresi di bawah tingkat kelulusan 95%|
...
|Tes|≥95% lulus (dasar: 166)|🔴 PEMBLOKIRAN|
